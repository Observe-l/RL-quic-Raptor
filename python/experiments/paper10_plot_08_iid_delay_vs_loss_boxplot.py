...
def main() -> None:
    ...
    ap.add_argument("--out", type=str, default="python/results/paper10_figs/08_iid_delay_vs_loss_mean_bar.pdf")
    ...
    for i, m in enumerate(methods):
        ys: List[float] = []
        for loss in losses:
            xs = [float(t.e2e_delay_ms) for (lp, t) in trials if lp == loss and t.method == m]
    ...
    # plt.title("IID: mean E2E delay vs loss rate")
